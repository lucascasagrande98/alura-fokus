...
const deleteFormTaskBtnChecked = document.querySelector("#btn-remover-concluidas");
const deleteFormTaskBtnAll = document.querySelector("#btn-remover-todas");
...
deleteFormTaskBtnChecked.addEventListener("click", () => removerTarefas(true));
deleteFormTaskBtnAll.addEventListener("click", () => removerTarefas(false));
